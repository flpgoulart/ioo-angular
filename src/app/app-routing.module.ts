...
const ROUTES = RouterModule.forRoot([
    //admin area
    // { path: 'occupation-areas/:id', component: OccupationAreaDetailComponent, canActivate: [IsAdminGuard] },
    // { path: 'occupation-areas',     component: OccupationAreasComponent, canActivate: [IsAdminGuard] },
